...
try {
    ...
    // Requête SQL pour récupérer l'ensemble des informations des étudiants dont le prénom commence par "T"
    ...
    echo '<thead style="border-collapse : collapse; border: 1px solid black;">';
    echo '<tr>';
    foreach ($students[0] as $fieldName => $value) {
        echo '<th style="border-collapse : collapse; padding : 15px; border: 1px solid black;">' . htmlspecialchars($fieldName) . '</th>';
    }
    echo '</tr>';
    echo '</thead>';
    echo '<tbody>';
